  ...
  .then((data) => {
    ...
    for(let icon in list){
        if(i == 0){
            ...
            let markDown = '[<img src="https://raw.githubusercontent.com/rdp-studio/macOS_Big_Sur_icons_replacements/master/icons/png/low-res/'+iconName+'.png" width="100">](https://github.com/elrumo/macOS-Big-Sur-icons-replacements/raw/master/icons/'+iconName+'.icns)<br>['+iconName+'](https://github.com/elrumo/macOS-Big-Sur-icons-replacements/raw/master/icons/'+iconName+'.icns),'
            i++
            csv.push(markDown)
        } else{
            let iconName = list[icon]
